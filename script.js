...
class Book{
  ...
  constructor(title, author, pages, read){
    ...
    this.pages = pages
    this.read = read
    this.info = () => (`${this.title} by ${this.author}, ${this.pages} pages, read book: ${this.read}`)
...
function changeReadBookStatus(){
  ...
  readBookButtons.forEach((element, index) => element.addEventListener("click", () => {
...
function removeBook(){
  ...
  removeButtons.forEach((element, index) => element.addEventListener("click", () => {
...
submitButton.addEventListener("click", () => {
  ...
  theHobbit = new Book(author.value, title.value, pages.value, hasReadBook.textContent.toLowerCase())
